...
public class PopMessage : MonoBehaviour {
	...
	public static void CreatePopMessage(){
		instance  = (Instantiate(Resources.Load("PopMessage/PopMessageCanvas")) as GameObject).GetComponent<PopMessage>();
	}
	...
	private void CheckEventSystemExist(){
		if (!GameObject.Find ("EventSystem")) {
			Instantiate (Resources.Load ("PopMessage/EventSystem"));
		}
	}
}
